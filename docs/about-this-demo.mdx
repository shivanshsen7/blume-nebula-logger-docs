...
<Steps>
  ...
  <Step title="Deployed as a static site">
...
<Diff
  lang="md"
  old={`Nebula Logger's docs, rebuilt as 40 structured pages\nvia a 33-agent fan-out — 148 Apex classes, 26 wiki\npages, MIT licensed.`}
  new={`Nebula Logger's docs, rebuilt as 39 structured pages\nvia a 33-agent fan-out — 53 Apex classes, 26 wiki\npages, MIT licensed.`}
/>
